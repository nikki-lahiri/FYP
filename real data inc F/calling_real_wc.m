...
for i=1:sz_omega
    ...
    %--------robust optimisation---------
    [w_rob,risk_rob,ret_rob,sharpe_rob,rho,w_coef,eig_H,D_bar,mu0,gam,eta]= robust2(n_assets,m_factors,p,f,asset_ret,alpha,omega_vec(i));
    
    
    %----------Worst-case----------------
    [risk_wc,ret_wc,sharpe_wc]=wc_classical(n_assets,m_factors,w_clas,rho,w_coef,eig_H,D_bar,mu0,gam,eta);
...
%        
    ...
    %-----mean comparisons----
    sharpe_comp(i)=sharpe_rob/sharpe_clas;
    %ret_comp=[ret; ret2]
    %risk_comp=[risk; risk2]
    ret_comp(i)=ret_rob/ret_clas;
    risk_comp(i)=risk_rob/risk_clas;
