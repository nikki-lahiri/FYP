function [risk_classical_wc,wc_ret,sharpe_wc]=wc_classical(n_assets,m_factors,classical_weights,rho,w_coef,eig_H,D_bar,mu0,gam)
...
Aineq4=[zeros(1,n_assets),ones(1,m_factors),0,1,-1;%d1
